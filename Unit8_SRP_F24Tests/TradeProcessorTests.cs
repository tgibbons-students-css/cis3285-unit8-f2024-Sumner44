...
namespace SingleResponsibilityPrinciple.Tests
{
    ...
    public class TradeProcessorTests
    {
        ...
        {
            using (var connection = new System.Data.SqlClient.SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\scotton\Documents\tradedatabase.mdf;Integrated Security=True;Connect Timeout=30"))
