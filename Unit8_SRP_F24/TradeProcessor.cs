...
namespace SingleResponsibilityPrinciple
{
    public class TradeProcessor
    {
        ...
        private void StoreTrades(IEnumerable<TradeRecord> trades)
        {
            ...
            string SumnerConnectString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\scotton\Documents\tradedatabase.mdf;Integrated Security=True;Connect Timeout=30";
            // Change the connection string used to match the one you want
            using (var connection = new SqlConnection(SumnerConnectString))
